...
const BookCard = ({ book, setBooks }) => {
    ...
    return (
        <>
            <Link to={`/book/${book._id}`} className={`relatie block rounded-xl bg-base-100 p-4 border transition-all duration-200 ${isActive ? "border-primary shadow-lg" : "border-base-300"} hover:border-primary hover:shadow-xl`}>
                ...
                <div className="mt-4 space-y-2">
                    <div className="flex items-center gap-2">
                        <BookOpen className="sixe-4 text-primary" />
